...
+ (void)getWithTokenURLString:(NSString *)urlString parameters:(NSDictionary *)parameters success:(DNSuccessBlock)success failure:(DNFailureBlock)failure{
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    NSString *token = [user objectForKey:user_key_token];
    [parameters setValue:token forKey:user_key_token];
    NSMutableDictionary *dic = [[NSMutableDictionary alloc] initWithDictionary:parameters];
    [dic setValue:token forKey:user_key_token];
    [self getWithURLString:urlString parameters:dic progress:^(NSProgress *progress) {
...
//    [session.requestSerializer setValue:@"" forHTTPHeaderFie-ld:@""];
...
+ (void)postWithTokenURLString:(NSString *)urlString parameters:(NSDictionary *)parameters success:(DNSuccessBlock)success failure:(DNFailureBlock)failure{
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    NSString *token = [user objectForKey:user_key_token];
    [parameters setValue:token forKey:user_key_token];
    NSMutableDictionary *dic = [[NSMutableDictionary alloc] initWithDictionary:parameters];
    [dic setValue:token forKey:user_key_token];
    [self postWithTokenURLString:(NSString *)urlString parameters:(NSDictionary *)dic success:(DNSuccessBlock)success failure:(DNFailureBlock)failure];
}
...
+ (void)postWithTokenURLString:(NSString *)urlString parameters:(NSDictionary *)parameters images:(NSArray *)images progress:(DNProgressBlock)progress success:(DNSuccessBlock)success failure:(DNFailureBlock)failure{
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    NSString *token = [user objectForKey:user_key_token];
    [parameters setValue:token forKey:user_key_token];
    NSMutableDictionary *dic = [[NSMutableDictionary alloc] initWithDictionary:parameters];
    [dic setValue:token forKey:user_key_token];
    [self postWithURLString:urlString parameters:dic images:images progress:progress success:success failure:failure];
}
