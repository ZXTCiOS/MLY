...
@interface myOrderVC2 ()<UITableViewDataSource,UITableViewDelegate,mycellVdelegate>
@property (nonatomic,strong) UITableView *ordertableView;
@property (nonatomic,strong) NSMutableArray *dataSource;
@property (nonatomic,copy) NSMutableArray *copydic;
@end

static NSString *myordercell2 = @"myordercell0identfid2";



@implementation myOrderVC2
...
-(void)headerRefreshEndAction
{
    ...
    NSString *token = [userDefault objectForKey:user_key_token];
    NSString *urlstr = [NSString stringWithFormat:get_myorder,userid,token,@"3"];
...
{
    myorderCell *cell = [tableView dequeueReusableCellWithIdentifier:myordercell2];
    cell =  [[myorderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:myordercell2];
