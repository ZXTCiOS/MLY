...
-(void)headerRefreshEndAction
{
    ...
    NSString *token = [userDefault objectForKey:user_key_token];
    NSString *urlstr = [NSString stringWithFormat:get_myorder,userid,token,@"0"];
...
{
    myorderCell *cell = [tableView dequeueReusableCellWithIdentifier:myordercell5];
    cell =  [[myorderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:myordercell5];
