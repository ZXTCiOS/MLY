...
static NSString *myordercell4 = @"myordercell0identfid4";


@implementation myOrderVC4
...
-(void)headerRefreshEndAction
{
    ...
    NSString *token = [userDefault objectForKey:user_key_token];
    NSString *urlstr = [NSString stringWithFormat:get_myorder,userid,token,@"4"];
...
{
    myorderCell *cell = [tableView dequeueReusableCellWithIdentifier:myordercell4];
    cell =  [[myorderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:myordercell4];
